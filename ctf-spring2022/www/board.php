...
<head>
	<head>
		<title>WallStreetBets Uber Edition 🚀🚀🚀</title>
		<meta charset="utf-8">
	...
	<?php
		...
		if (empty($id)) {
			echo '<div id="header"><h1><img id="logo" src="logo.jpg" /><br/>WallStreetBets Uber Edition 🚀🚀🚀</h1></div>';
			...
			echo '<div id="header"><h1 id="logo">WallStreetBets Uber Edition</h1></div>';
